        ...
        var startApp = function () {
            gapi.load('auth2', function () {
                ...
                auth2 = gapi.auth2.init({
                    client_id: '205585355135-npei850ktg50c7bgt8h2ep82oeui98gq.apps.googleusercontent.com',
...
//             console.log("la fb login email: " + response);
    ...
    function getInfo() {
        FB.api('/me?fields=email,id', 'GET', {}, function (response) {
            var pockeyCustomEvent = new CustomEvent("PockeyFacebookSignedIn", {
                detail: {
            ...
            <div id="InventoryElementsHolder">
                ...
                <div id="ItemPanel">
                    <div id="ItemInfoHolder">
                        ...
                        <div id="EquipButtonWrapper"><div id="EquipButtonHolder">
                            <div id="" class="normalButtonHolder">
                                <div class="normalButtonBackground">Equip</div>
                            </div>
                        </div></div>
                ...
                <div id="LeaderBoardRankings">
                    <div id="LeaderboardRowsHolder">
                        ...
                        <div class="leaderBoardRow">
                            ...
                            <div class="normalCell leaderBoardNameCell">first name</div>
