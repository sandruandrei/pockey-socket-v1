...
declare namespace p2 {
    ...
    export class Ray {
        ...
        intersectBodies(result, bodies): void;

        intersectBody(result, body): void;

        intersectShape(result, shape, angle, position, body): void;

        getAABB(result): void;

        reportIntersection(result, fraction, normal, faceIndex): void;
    ...
    export class RaycastResult {
        ...
        getHitPoint(out, ray):void;

        stop(): number;

        shouldStop(ray): boolean;

        set(normal, shape, body, fraction, faceIndex): number;
    ...
    export class vec2 {
         ...
         * @param {Array} normal
         */
        static reflect(out: number[], vector:number[], normal:number[]):number[];
    }
